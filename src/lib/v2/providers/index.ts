...
export const MODEL_REGISTRY: Record<ModelRole, ModelInfo> = {
  orchestrator: {
    ...
    modelId: parseModelId(process.env.HARIS_ORCHESTRATOR_MODEL, "claude-fable-5-1"),
    displayName: getDisplayName(process.env.HARIS_ORCHESTRATOR_MODEL, "Claude Fable 5.1"),
  ...
  analyzer: {
    ...
    modelId: parseModelId(process.env.HARIS_ANALYZER_MODEL, "claude-opus-5-5"),
    displayName: getDisplayName(process.env.HARIS_ANALYZER_MODEL, "Claude Opus 5.5"),
    contextWindow: 200_000,
    costPer1MInput: 5,
    costPer1MOutput: 25,
    costPer1MCacheWrite: 6.25,
  ...
  opposition: {
    ...
    modelId: parseModelId(process.env.HARIS_OPPOSITION_MODEL, "gpt-6-astra"),
    displayName: getDisplayName(process.env.HARIS_OPPOSITION_MODEL, "GPT-6 Astra"),
  ...
  drafter: {
    ...
    modelId: parseModelId(process.env.HARIS_DRAFTER_MODEL, "claude-fable-5-1"),
    displayName: getDisplayName(process.env.HARIS_DRAFTER_MODEL, "Claude Fable 5.1"),
    contextWindow: 200_000,
    costPer1MInput: 5,
    costPer1MOutput: 25,
    costPer1MCacheWrite: 6.25,
  ...
  quick: {
    role: "quick",
    provider: parseProvider(process.env.HARIS_QUICK_MODEL, "openai"),
    modelId: parseModelId(process.env.HARIS_QUICK_MODEL, "gpt-5.6-sol"),
    displayName: getDisplayName(process.env.HARIS_QUICK_MODEL, "GPT-5.6 Sol"),
    contextWindow: 200_000,
    costPer1MInput: 3,
    costPer1MOutput: 15,
  ...
  vision: {
    ...
    modelId: parseModelId(process.env.HARIS_VISION_MODEL, "claude-opus-5-5"),
    displayName: getDisplayName(process.env.HARIS_VISION_MODEL, "Claude Opus 5.5 Vision"),
    contextWindow: 200_000,
    costPer1MInput: 5,
    costPer1MOutput: 25,
    supportsCaching: false,
